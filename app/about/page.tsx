          ...
          >
            <div className="bg-white rounded-3xl p-12 shadow-xl border border-gray-200">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                ...
                <p>
                  Today, Clearlearn serves thousands of students worldwide, helping them master everything from organic 
                  chemistry to machine learning through our innovative AI tutoring system.
                </p>
              </div>
            </div>
          </motion.div>
