...
import { ElbowFitting, TeeFitting, ReducerFitting, UnionFitting, CouplingFitting } from './fittings/PlumbingFittings'
import { ToiletFixture, KitchenSink, BallValve, WaterHeater } from './fixtures/PlumbingFixtures'
import { PipeWrench, TubingCutter, ChannelLocks, ThreadingMachine, ToolBox } from './tools/PlumbingTools'
...
interface PlumbingSceneComposerProps {
  ...
  onComponentSelect?: (component: PlumbingComponent | PlumbingTool) => void
  className?: string
}
...
function SampleInstallation({ onComponentSelect }: { onComponentSelect?: (item: any) => void }) {
