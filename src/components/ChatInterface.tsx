    ...
    <div className="flex flex-col h-full max-w-5xl mx-auto bg-white">
      ...
      <div className="border-b border-gray-100 bg-white/80 backdrop-blur-lg p-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-black">TradeAI Tutor</h1>
          <p className="text-gray-600 mt-2">Your expert plumbing and trades learning companion</p>
        </div>
      </div>
        ...
        {messages.length === 0 && (
          <div className="text-center py-24">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Ask me anything about plumbing and the trades
            </h2>
            <p className="text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed">
              I’ll provide detailed, step-by-step guidance and the right videos to master real-world skills
            </p>
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <div className="text-gray-700">\"Show me how to fix a sink drainage leak\"</div>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                <div className="text-sm font-semibold text-gray-600 mb-2">Or ask about:</div>
                <div className="text-gray-700">\"What’s the proper venting for a bathroom?\"</div>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="border-t border-gray-100 bg-white p-8">
        <form onSubmit={handleSubmit} className="flex space-x-4 max-w-4xl mx-auto">
          <input
            ...
            placeholder="Ask about plumbing repairs, installs, codes, or troubleshooting..."
            disabled={isLoading}
