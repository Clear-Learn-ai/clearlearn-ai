...
export default function LandingPage() {
  const [_demoStep] = useState(0)
  useScrollAnimation()
  const heroYouTubeUrl = process.env.NEXT_PUBLIC_HERO_YOUTUBE_URL || 'https://www.youtube.com/watch?v=VFl7Hrm5q-s'
        ...
        <section style={{ backgroundColor: '#B87A7A' }} className="relative z-10 min-h-screen flex items-center">
          <div className="max-w-7xl mx-auto px-6 w-full">
            <div className="text-center fade-in" id="demo-section">
              ...
              <div ref={heroRef} className="relative rounded-2xl overflow-hidden shadow-2xl w-full max-w-6xl mx-auto" style={{ backgroundColor: '#1E0F2E' }}>
                <div className="aspect-video" style={{ minHeight: '70vh' }}>
                  <iframe
                    src={`https://www.youtube.com/embed/${extractYouTubeId(heroYouTubeUrl)}?autoplay=${heroReady ? 1 : 0}&mute=1&modestbranding=1&rel=0&vq=hd2160`}
                    title="TradeAI Tutor Demo"
